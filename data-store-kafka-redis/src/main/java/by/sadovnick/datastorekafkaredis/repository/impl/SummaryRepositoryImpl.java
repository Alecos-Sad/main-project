package by.sadovnick.datastorekafkaredis.repository.impl;

import by.sadovnick.datastorekafkaredis.config.RedisSchema;
...
public class SummaryRepositoryImpl implements SummaryRepository {
    ...
    @Override
    public Optional<Summary> findBySensorsId(
            long sensorId,
